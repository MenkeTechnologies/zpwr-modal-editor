...
// zmodal-editor: vendored tiny replacements for lodash.throttle / lodash.kebabcase
// so the package carries no external runtime deps (we own this code).
import { throttle, kebabCase } from './localutil';
